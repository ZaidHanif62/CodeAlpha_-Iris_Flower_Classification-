...
# 🔹 Load dataset directly (since file is already uploaded in repo)
df = pd.read_csv("iris.csv")
st.success("Default Iris dataset loaded successfully!")
...
st.markdown("<h4 style='text-align: center; color: #8e44ad;'>👨‍💻 Zaid Hanif</h4>", unsafe_allow_html=True)
